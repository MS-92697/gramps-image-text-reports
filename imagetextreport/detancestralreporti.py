...
# ------------------------------------------------------------------------
#
# ImageDetAncestorReport
#
# ------------------------------------------------------------------------
# TODO see what can be derived from standard report
# gramps.plugins.textreport.detancestralreport.DetAncestorReport
# without carrying duplicate code all on the way
class ImageDetAncestorReport(Report):
    """the Detailed Ancestor Report with images"""

    def __init__(self, database, options, user):
        """
        Create the ImageDetAncestorReport object that produces the report.
...
# ------------------------------------------------------------------------
#
# ImageDetAncestorReportOptions
#
# ------------------------------------------------------------------------
class ImageDetAncestorReportOptions(MenuReportOptions):
    """
